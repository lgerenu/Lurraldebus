...
public class DBHelper extends SQLiteOpenHelper {
   ...
   * 
   * @param path
   *          Datu basearen kokaleku eta izena.
  ...
  public List<Geltokia> geltokiakIrakurri() {
    ...
    c.moveToFirst();
    do {
      Geltokia geltokia = new Geltokia(c.getInt(0), c.getString(1), c.getString(2), c.getDouble(3),
          c.getDouble(4), 0);
  ...
  public List<StopTimes> geldialdiakIrakurri(int geltokiaId, int maxOrduaSeg, int minOrduaSeg) {
    ...
    String[] irakurtzekoDatuak = { "trip_id", "arrival_time", "departure_time", "stop_id",
        "stop_sequence", "arrival_time_seconds", "departure_time_seconds" };
    String baldintzak = "stop_id=" + geltokiaId + " AND arrival_time_seconds>" + minOrduaSeg
        + " AND arrival_time_seconds<" + maxOrduaSeg;
    Cursor c = db.query("gtfs_stop_times", irakurtzekoDatuak, baldintzak, null, null, null,
    ...
    if (c.getCount() > 0) {
      do {
        ...
        StopTimes geldiunea = new StopTimes(c.getInt(0), c.getString(1), c.getString(2),
  ...
  public boolean gaurDaBidaia(String gaurkoData, int service_id) {
    ...
    Cursor c = db.query("gtfs_calendar_dates", irakurtzekoDatuak, baldintzak, null, null, null,
        null, null);
    c.moveToFirst();
